  ...
  const plans = [
    {
      ...
      priceId: null,
      features: Array.isArray(t('pricing.free.features')) ? t('pricing.free.features') as string[] : [],
    ...
    },
    {
      ...
      features: Array.isArray(t('pricing.pro.features')) ? t('pricing.pro.features') as string[] : [],
    ...
    },
    {
      ...
      features: Array.isArray(t('pricing.business.features')) ? t('pricing.business.features') as string[] : [],
